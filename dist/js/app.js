  ...
  _createClass(Board, [{
    ...
    value: function getWords() {
      ...
      for (var row = 0; row < this.rowLength; row++) {
        ...
        for (var column = 0; column < this.rowLength; column++) {
          var field = this.fields[row * this.rowLength + column];
          var letter = field.getAttribute('data-letter');
          if (letter) word += letter;else {
      ...
      for (var _column = 0; _column < this.rowLength; _column++) {
        var _word = '';

        for (var _row = 0; _row < this.rowLength; _row++) {
          var _field = this.fields[_column + _row * this.rowLength];

          var _letter = _field.getAttribute('data-letter');

          if (_letter) _word += _letter;else {
            if (_word.length >= 2) words.push(_word);
            _word = '';
          }
        }
...
/* harmony import */ var _TileContainer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TileContainer */ "./src/modules/TileContainer.js");
...
var StartScrabble = /*#__PURE__*/function () {
  ...
  _createClass(StartScrabble, [{
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                if (!(i < this.tileContiner.rows.length)) {
                  _context.next = 8;
                  break;
                }

                _context.next = 5;
                return this.giveTile();
    ...
    key: "giveTile",
    value: function () {
      var _giveTile = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2() {
        var tile;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                tile = this.tileContiner.giveTile(this.notFreeRow.bind(this), this.freeRow.bind(this));
                ...
                return _context2.abrupt("return", new Promise(function (response) {
      ...
      function giveTile() {
        return _giveTile.apply(this, arguments);
      }
    ...
    key: "notFreeRow",
    value: function notFreeRow(mouseX, mouseY, letter) {
      var _this = this;

      var rows = [].concat(_toConsumableArray(this.board.fields), _toConsumableArray(this.tileContiner.rows));
      var freeRows = rows.filter(function (field) {
        return !field.getAttribute('data-letter');
      });
      freeRows.sort(function (a, b) {
        var aPos = a.getBoundingClientRect();
        var bPos = b.getBoundingClientRect();

        var aDistance = _this.getDistance(aPos.left, mouseX, aPos.top, mouseY);

        var bDistance = _this.getDistance(bPos.left, mouseX, bPos.top, mouseY);

        return aDistance - bDistance;
      });
      var targetRow = freeRows[0];
...
var Tile = /*#__PURE__*/function () {
  function Tile(letter, notFreeRow, freeRow) {
  ...
  _createClass(Tile, [{
    ...
    key: "grab",
    value: function grab(mouseX, mouseY) {
    ...
    key: "setPosition",
    value: function setPosition(x, y, scale, rotation) {
      this.elem.style.transform = "translate(".concat(x, "px, ").concat(y, "px) scale(").concat(scale, ") rotate(").concat(rotation, "deg)");
    }
  }, {
    key: "setTransition",
    value: function setTransition(state) {
    ...
    value: function setSize(size) {
      this.size = size;
      if (size <= 40) this.elem.classList.add('small');else this.elem.classList.remove('small');
      this.elem.style.width = "".concat(size - 4, "px");
      this.elem.style.height = "".concat(size - 4, "px");
    }
  }, {
    key: "setPositionToTargetRow",
    value: function () {
      var _setPositionToTargetRow = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
        var targetPos, rotation;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                targetPos = this.targetRow.getBoundingClientRect();
                rotation = this.targetRow.getAttribute('data-rotation');
      ...
      function setPositionToTargetRow() {
        return _setPositionToTargetRow.apply(this, arguments);
      }

      return setPositionToTargetRow;
    }()
  }, {
    key: "events",
    value: function events() {
      ...
      this.elem.addEventListener('mousedown', function (ev) {
        _this.grab(ev.clientX, ev.clientY);
      });
      document.body.addEventListener('mousemove', function (ev) {
        _this.move(ev.clientX, ev.clientY);
      });
      document.body.addEventListener('mouseup', this.release.bind(this));
      this.elem.addEventListener('touchstart', function (ev) {
        _this.grab(ev.touches[0].clientX, ev.touches[0].clientY);
      });
      document.body.addEventListener('touchmove', function (ev) {
        ev.preventDefault();

        _this.move(ev.touches[0].clientX, ev.touches[0].clientY);
      }, {
        passive: false
      });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ TileContainer)
/* harmony export */ });
...
var TileContainer = /*#__PURE__*/function () {
  ...
  _createClass(TileContainer, [{
    ...
    value: function giveTile(notFreeRow, freeRow) {
      ...
      var lettersContainerPosition = this.letters.getBoundingClientRect();
      this.letters.classList.add('created_letters_container');
      var letter = this.availableLetters[this.givenLetters];
      targetRow.setAttribute('data-letter', letter);
      targetRow.setAttribute('data-rotation', (Math.random() - 0.5) * 20);
      var tile = new _Tile__WEBPACK_IMPORTED_MODULE_0__["default"](letter, notFreeRow, freeRow);
    ...
    key: "setRowSize",
    value: function setRowSize(size) {
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          field.style.width = "".concat(size, "px");
          field.style.height = "".concat(size, "px");
        }
      } catch (err) {
        _iterator2.e(err);
      } finally {
