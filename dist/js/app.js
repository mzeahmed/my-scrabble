...
var Board = /*#__PURE__*/function () {
  ...
  _createClass(Board, [{
    key: "boardInit",
    value: function boardInit() {
      this.fields = [];
      var fieldNum = Math.pow(this.rowLength, 2); // Création des rangées
    ...
    value: function boardRender() {
      ...
      var rowDimensions = this.elem.getBoundingClientRect();

      if (rowDimensions.width > rowDimensions.height) {
        this.elem.style.width = "".concat(rowDimensions.height, "px");
      } else {
        this.elem.style.height = "".concat(rowDimensions.width, "px");
      }
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmon_scrabble"] = self["webpackChunkmon_scrabble"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./assets/app.scss")))
